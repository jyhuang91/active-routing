...
#do
#  ./mcsim -mdfile ../Apps/md/md-16o3core-mesh-hmc.py -runfile ../Apps/list/run-ar-${microbench}.py -benchname dfly_arftid_${microbench} > dfly_log/arftid_${microbench}.log 2>&1 &
#done
