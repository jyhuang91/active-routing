...
namespace CasHMC
{
  ...
  class TranStatistic
  {
    public:
      ...
      vector<uint64_t> linkActTransmitSize;	//[Byte]
      vector<uint64_t> linkPasTransmitSize;	//[Byte]
      vector<uint64_t> linkFlowTransmitSize;	//[Byte]
      ...
      vector<uint64_t> totalhmcCtrlLinkTransmitSize;
      vector<uint64_t> totalLinkActTransmitSize;
      vector<uint64_t> totalLinkPasTransmitSize;
      vector<uint64_t> totalLinkFlowTransmitSize;
