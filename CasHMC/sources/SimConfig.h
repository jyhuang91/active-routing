...
//Link Topology, Ram
//
static int LEFT_LINK = 0;
static int TOP_LINK = 1;
static int RIGHT_LINK = 2;
static int BOT_LINK = 3;

// Ram
static int CPU_LINKS = 4;//1;

//
//Jiayi, Operand Buffer
//
static int MAX_OPERAND_BUF = 128;
static int MAX_VAULT_OPERAND_BUF = 4;

extern bool gVLP; // vault-level parallelism
