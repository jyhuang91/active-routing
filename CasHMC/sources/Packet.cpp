...
namespace CasHMC
{
  ...
  ostream& operator<<(ostream &out, const Packet &f)
  {
    ...
    switch(f.CMD) {
      //Request commands
      case WR16:  header = "[P" + id.str() + "-WR16]";  break;
      case WR32:  header = "[P" + id.str() + "-WR32]";  break;
      case WR48:  header = "[P" + id.str() + "-WR48]";  break;
      case WR64:  header = "[P" + id.str() + "-WR64]";  break;
      case WR80:  header = "[P" + id.str() + "-WR80]";  break;
      case WR96:  header = "[P" + id.str() + "-WR96]";  break;
      case WR112: header = "[P" + id.str() + "-WR112]"; break;
      case WR128: header = "[P" + id.str() + "-WR128]"; break;
      case MD_WR: header = "[P" + id.str() + "-MD_WR]"; break;
      case WR256: header = "[P" + id.str() + "-WR256]"; break;
      case P_WR16:  header = "[P" + id.str() + "-P_WR16]";  break;
      case P_WR32:  header = "[P" + id.str() + "-P_WR32]";  break;
      case P_WR48:  header = "[P" + id.str() + "-P_WR48]";  break;
      case P_WR64:  header = "[P" + id.str() + "-P_WR64]";  break;
      case P_WR80:  header = "[P" + id.str() + "-P_WR80]";  break;
      case P_WR96:  header = "[P" + id.str() + "-P_WR96]";  break;
      case P_WR112: header = "[P" + id.str() + "-P_WR112]"; break;
      case P_WR128: header = "[P" + id.str() + "-P_WR128]"; break;
      case P_WR256: header = "[P" + id.str() + "-P_WR256]"; break;
      case RD16:  header = "[P" + id.str() + "-RD16]";  break;
      case RD32:  header = "[P" + id.str() + "-RD32]";  break;
      case RD48:  header = "[P" + id.str() + "-RD48]";  break;
      case RD64:  header = "[P" + id.str() + "-RD64]";  break;
      case RD80:  header = "[P" + id.str() + "-RD80]";  break;
      case RD96:  header = "[P" + id.str() + "-RD96]";  break;
      case RD112: header = "[P" + id.str() + "-RD112]"; break;
      case RD128: header = "[P" + id.str() + "-RD128]"; break;
      case RD256: header = "[P" + id.str() + "-RD256]"; break;
      case MD_RD: header = "[P" + id.str() + "-MD_RD]"; break;
      //ATOMICS commands
      case _2ADD8:  header = "[P" + id.str() + "-2ADD8]";   break;
      case ADD16:   header = "[P" + id.str() + "-ADD16]";   break;
      case P_2ADD8: header = "[P" + id.str() + "-P_2ADD8]"; break;
      case P_ADD16: header = "[P" + id.str() + "-P_ADD16]"; break;
      case _2ADDS8R:header = "[P" + id.str() + "-2ADDS8R]"; break;
      case ADDS16R: header = "[P" + id.str() + "-ADDS16R]"; break;
      case INC8:    header = "[P" + id.str() + "-INC8]";    break;
      case P_INC8:  header = "[P" + id.str() + "-P_INC8]";  break;
      case XOR16:   header = "[P" + id.str() + "-XOR16]";   break;
      case OR16:    header = "[P" + id.str() + "-OR16]";    break;
      case NOR16:   header = "[P" + id.str() + "-NOR16]";   break;
      case AND16:   header = "[P" + id.str() + "-AND16]";   break;
      case NAND16:  header = "[P" + id.str() + "-NAND16]";  break;
      case CASGT8:  header = "[P" + id.str() + "-CASGT8]";  break;
      case CASLT8:  header = "[P" + id.str() + "-CASLT8]";  break;
      case CASGT16: header = "[P" + id.str() + "-CASGT16]"; break;
      case CASLT16: header = "[P" + id.str() + "-CASLT16]"; break;
      case CASEQ8:  header = "[P" + id.str() + "-CASEQ8]";  break;
      case CASZERO16: header = "[P" + id.str() + "-CASZR16]"; break;
      case EQ16:  header = "[P" + id.str() + "-EQ16]";  break;
      case EQ8:   header = "[P" + id.str() + "-EQ8]";   break;
      case BWR:   header = "[P" + id.str() + "-BWR]";   break;
      case P_BWR: header = "[P" + id.str() + "-P_BWR]"; break;
      case BWR8R: header = "[P" + id.str() + "-BWR8R]"; break;
      case SWAP16:header = "[P" + id.str() + "-SWAP16]";break;
      //Flow Commands
      case NULL_: header = "[P" + id.str() + "-NULL]";  break;
      case PRET:  header = "[P" + id.str() + "-PRET]";  break;
      case TRET:  header = "[P" + id.str() + "-TRET]";  break;
      case IRTRY:
        if(f.FRP==1) header = "[P" + id.str() + "-IRTRY1]";
        else if(f.FRP==2) header = "[P" + id.str() + "-IRTRY2]";
        else header = "[P" + id.str() + "-IRTRY]";  break;
                      //Respond commands
      case RD_RS: header = "[P" + id.str() + "-RD_RS]"; break;
      case WR_RS: header = "[P" + id.str() + "-WR_RS]"; break;
      case MD_RD_RS:  header = "[P" + id.str() + "-MD_RD_RS]"; break;
      case MD_WR_RS:  header = "[P" + id.str() + "-MD_WR_RS]"; break;
      // active commands
