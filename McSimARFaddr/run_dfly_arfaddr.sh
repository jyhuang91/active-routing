...
do
  ./mcsim -mdfile ../Apps/md/md-16o3core-mesh-hmc.py -runfile ../Apps/list/run-${microbench}.py -benchname dfly_arfaddr_${microbench} > dfly_log/arfaddr_${microbench}.log 2>&1 &
done
